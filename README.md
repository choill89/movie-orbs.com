...
영화 정보를 시각적이고 탐색하기 쉬운 '오브(Orbs)' 형태로 제공하는 웹 애플리케이션입니다. 프로젝트에 대한 상세 정보는 아래의 드롭다운 메뉴를 클릭하여 확인하실 수 있습니다.

---

<details>
<summary>💡 1. 프로젝트 소개 (Project Introduction)</summary>
<div id="introduction" markdown="1">
...
* **🔮 인터랙티브 Orb UI:** 최신 인기 영화, 장르별 영화를 오브 형태로 시각화합니다.
* **🔍 실시간 스마트 검색:** 초성 검색 및 영/한 키워드 매칭을 통해 원하는 영화를 찾아냅니다.
